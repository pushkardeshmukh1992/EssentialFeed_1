...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut: sut, withCompleteWith: .failure(RemoteFeedLoader.Error.connectivity)) {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut: sut, withCompleteWith: .failure(RemoteFeedLoader.Error.invalidData)) {
    ...
    func test_load_deliversNoItemsOn200HTTPResponseWithEmptyJSONList() {
        ...
        expect(sut: sut, withCompleteWith: .success([]), when: {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        expect(sut: sut, withCompleteWith: .success(items), when: {
    ...
    private func expect(sut: RemoteFeedLoader, withCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
